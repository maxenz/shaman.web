...
Public Class conSanatorios
    Inherits typSanatorios
    ...
    Public Function GetIDByAbreviaturaId(ByVal pVal As String) As Int64
        ...
        Try
            Dim SQL As String
            SQL = "SELECT ID FROM Sanatorios WHERE (AbreviaturaId = '" & pVal & "')"
    ...
    Public Function GetIDByDescripcion(ByVal pVal As String) As Int64
        ...
        Try
            Dim SQL As String
            SQL = "SELECT ID FROM Sanatorios WHERE (Descripcion = '" & pVal & "')"
    ...
    Public Function Validar(Optional ByVal pMsg As Boolean = True) As Boolean
        ...
        Try
            Dim vRdo As String = ""
            Validar = True
            If Me.AbreviaturaId = "" Then vRdo = "Debe determinar el código identificador del sanatorio"
            If Me.Descripcion = "" And vRdo = "" Then vRdo = "Debe determinar el nombre del sanatorio"
            If Me.LocalidadId.GetObjectId = 0 And vRdo = "" Then vRdo = "Debe determinar la localidad del sanatorio"
            If Me.Domicilio.dmCalle = "" And vRdo = "" Then vRdo = "Debe determinar el domicilio del sanatorio"
            If vRdo <> "" Then
                Validar = False
