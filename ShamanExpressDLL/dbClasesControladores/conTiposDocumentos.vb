...
Public Class conTiposDocumentos
    Inherits typTiposDocumentos
    ...
    Public Function GetIDByAbreviaturaId(ByVal pVal As String) As Int64
        ...
        Try
            Dim SQL As String
            SQL = "SELECT ID FROM TiposDocumentos WHERE (AbreviaturaId = '" & pVal & "')"
    ...
    Public Function GetIDByDescripcion(ByVal pVal As String) As Int64
        ...
        Try
            Dim SQL As String
            SQL = "SELECT ID FROM TiposDocumentos WHERE (Descripcion = '" & pVal & "')"
    ...
    Public Function Validar(Optional ByVal pMsg As Boolean = True) As Boolean
        ...
        Try
            Dim vRdo As String = ""
            Validar = True
            If Me.AbreviaturaId = "" Then vRdo = "Debe determinar el código del tipo de documento"
            If Me.Descripcion = "" And vRdo = "" Then vRdo = "Debe determinar el nombre del tipo de documento"
            If vRdo <> "" Then
                Validar = False
    ...
    Public Function GetDefault() As Int64
        ...
        Try
            Dim SQL As String
            SQL = "SELECT ID FROM TiposDocumentos WHERE flgDefault = 1"
    ...
    Public Function SetDefault(ByVal pTdc As Int64) As Boolean
        SetDefault = False
        Try
            Dim SQL As String = "UPDATE TiposDocumentos SET flgDefault = 0 WHERE flgDefault = 1"
            Dim cmDel As New SqlCommand(SQL, cnnsNET(Me.myCnnName), cnnsTransNET(Me.myCnnName))
            cmDel.ExecuteNonQuery()

            Dim objTipoDocumento As New conTiposDocumentos(Me.myCnnName)
            If objTipoDocumento.Abrir(pTdc) Then
                objTipoDocumento.flgDefault = 1
                SetDefault = objTipoDocumento.Salvar(objTipoDocumento)
            End If
