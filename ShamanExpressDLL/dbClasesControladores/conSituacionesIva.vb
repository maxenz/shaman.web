...
Public Class conSituacionesIva
    Inherits typSituacionesIva
    ...
    Public Function GetIDByAbreviaturaId(ByVal pVal As String) As Int64
        ...
        Try
            Dim SQL As String
            SQL = "SELECT ID FROM SituacionesIva WHERE (AbreviaturaId = '" & pVal & "')"
    ...
    Public Function GetIDByDescripcion(ByVal pVal As String) As Int64
        ...
        Try
            Dim SQL As String
            SQL = "SELECT ID FROM SituacionesIva WHERE (Descripcion = '" & pVal & "')"
    ...
    Public Function Validar(Optional ByVal pMsg As Boolean = True) As Boolean
        ...
        Try
            Dim vRdo As String = ""
            Validar = True
            If Me.AbreviaturaId = "" Then vRdo = "Debe determinar el código de la situación ante el IVA"
            If Me.Descripcion = "" And vRdo = "" Then vRdo = "Debe determinar el nombre de la situación ante el IVA"
            If vRdo <> "" Then
                Validar = False
